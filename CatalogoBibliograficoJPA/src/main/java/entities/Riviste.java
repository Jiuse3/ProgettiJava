...
public class Riviste extends Catalogo {
   ...
   @Enumerated(EnumType.STRING)
    ...
    public String toString() {
        String stringa = "Titolo: "+ this.getTitle() + " Anno di pubblicazione: " + this.getAnnoPub() + " Numero di pagine: " + this.getNumPag() + " Periodicità: "+this.getPeriod()+ " Codice ISBN: " + this.getIsbn() ;
        return  stringa;
    }
